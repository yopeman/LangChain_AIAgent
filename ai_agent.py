...
class AIAgent:
    ...
    def _parse_output(self, result: Dict[str, Any]) -> Union[BaseModel, Dict[str, Any]]:
        ...
        if structured_data is None:
            ...
            if isinstance(result, dict) and all(k not in result for k in ['messages', 'output']):
        ...
        try:
            ...
            import warnings
            warnings.warn(f"Failed to parse response as {self.response_format.__name__}: {e}")
            return result
    ...
    def get_agent_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "response_format_type": self.response_format.__name__ if self.response_format else None,
